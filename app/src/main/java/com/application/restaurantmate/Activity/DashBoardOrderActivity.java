...
import com.application.restaurantmate.Adapter.DashboardAdapter;
...
public class DashBoardOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dash_board_order);
        ...
        adapter = new DashboardAdapter(this, dataSnapshots);
    ...
    public void addChangedRemovedTableListener(){
        ...
        //orderRef.orderByChild("status").equalTo("SendToCooker").addChildEventListener(new ChildEventListener() {
